...
var _minond$brainfuck$Main$mergeState = F2(
	function (_p0, model) {
		var _p1 = _p0;
		return _elm_lang$core$Native_Utils.update(
			model,
...
var _minond$brainfuck$Main$mono = function (str) {
	return A2(
...
var _minond$brainfuck$Main$editorInformation = function (_p7) {
	...
	var programSize = _elm_lang$core$String$length(_p11);
	...
	var opt = A2(
		_elm_lang$core$Maybe$withDefault,
		' ',
		A2(_elm_lang$core$Array$get, _p10, opts));
	var codeSize = _elm_lang$core$Array$length(opts);
	return {
		ctor: '::',
		_0: A2(
										...
										_1: {
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html$text(' steps so far. '),
														_1: {
															ctor: '::',
															_0: outputMessage,
															_1: {ctor: '[]'}
	...
	function (message, model) {
		...
		switch (_p12.ctor) {
			...
			case 'Tick':
				return {
					ctor: '_Tuple2',
					_0: A2(_minond$brainfuck$Main$mergeState, _p12._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SetDelay':
				var delay = function () {
			...
			default:
				var _p14 = _p12._0;
				var breakpoints = A2(_elm_lang$core$List$member, _p14, model.breakpoints) ? A2(
					_elm_lang$core$List$filter,
					F2(
						function (x, y) {
							return !_elm_lang$core$Native_Utils.eq(x, y);
						})(_p14),
					model.breakpoints) : {ctor: '::', _0: _p14, _1: model.breakpoints};
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
							...
							return A2(
								...
								function (steps) {
									return _elm_lang$core$Json_Decode$succeed(
										{memory: memory, idx: idx, pointer: pointer, steps: steps});
								},
...
var _minond$brainfuck$Main$editorProgram = function (_p15) {
	var _p16 = _p15;
	var getProgram = A2(
		_elm_lang$core$Json_Decode$map,
		function (s) {
...
var _minond$brainfuck$Main$Tick = function (a) {
...
var _minond$brainfuck$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _minond$brainfuck$Main$tick(_minond$brainfuck$Main$Tick),
			_1: {
				ctor: '::',
...
var _minond$brainfuck$Main$editorControls = function (_p17) {
	var _p18 = _p17;
	var _p19 = _p18.delay;
	var setProgram = A2(
		_elm_lang$core$Json_Decode$map,
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_minond$brainfuck$Main$Run),
											_1: {ctor: '[]'}
										},
										'Run'),
									_1: {
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_minond$brainfuck$Main$Step),
													_1: {ctor: '[]'}
												},
												'Step'),
											_1: {
						...
						},
						{
							...
							_1: {
								...
								_0: A2(
									_elm_lang$html$Html$section,
									{ctor: '[]'},
									_minond$brainfuck$Main$editorMemory(model)),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$section,
...
if (typeof _minond$brainfuck$Main$main !== 'undefined') {
    _minond$brainfuck$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"Tick":["Main.ProgramState"],"Breakpoint":["Int"],"SetProgram":["String"],"Run":[],"Output":["String"],"SetDelay":["String"],"EditorInput":["String"],"Step":[],"Pause":[],"Continue":[]}}},"aliases":{"Main.ProgramState":{"args":[],"type":"{ memory : List Int, idx : Int, pointer : Int, steps : Int }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
